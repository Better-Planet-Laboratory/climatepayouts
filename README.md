...
|Loss and damage functions| The functions estimated to explain the relationship between farm size and either production loss or proportion of lost revenue were developed by Zia Mehrabi and the methodology and underlying datasets can be found [here]( [https://github.com/Better-Planet-Laboratory/lossdamage](https://github.com/Better-Planet-Laboratory/farm-loss-farmsize)). This work builds on previous dataset developed by Zia Mehrabi, Julie Fortin and Navin Ramankutty, which harmonized household survey data across 17 countries to examine the relationship between farm size and climate shock impacts.|
