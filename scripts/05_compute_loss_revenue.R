...
### PART 1: Historical yearly and cummulative losses/lost revenue
#drought
...
### PART 2: SSP yearly and cumulative losses/lost revenue
#drought
testdrought <- read_csv("intermediate/spei_12_ensemble_drought_ssp585_predictions_high.csv")
testdrought$high_loss <- testdrought$pred_loss*testdrought$high*testdrought$frm2050
testdrought$high_rev <- testdrought$high*testdrought$pred_rev
...
#floods
#drought
testflood <- read_csv("intermediate/spei_12_ensemble_flood_ssp585_predictions_high.csv")
testflood$high_loss <- testflood$pred_loss*testflood$high*testflood$frm2050
testflood$high_rev <- testflood$high*testflood$pred_rev
...
joint <- bind_rows(loss, rev)
joint$model <- "ssp585"
write_csv(joint, "intermediatel/allloss_by_threshold_fin_spei12_ssp585.csv")



### PART 3: Join all historical and ssp datasets
